...
const Home_section8 = ({ videos, error }) => {
  ...
  return (
    ...
    <div className="Bg-cl3">
      <div className="vjl-cntr">
        ...
        <div className="vjl-row">
          <div className="vjl-md-12">
            <ul className="crd-d_v1-ul crd-d_v1-4">

             
           {videos && videos.map((video) => (
    <li className="crd-d_v1-li" key={video.id}>
      <div className="crd-b">
          ...
          <div className="VdTgIm-Crd">
            <div className="VdTgIm-Crd_lt">
              <span className="VdTgIm-Crd_vd">
                <FaPlay className="vj_play"/> {formatDuration(video['media:duration'])}
              </span>
            </div>
          </div>
        </Link>
        ...
        <div className="crd_txt-wrp crd-b_Txbg1">
          <h3 className="crd_D-ttl2">
            <Link className="crd_lnk" href={video.link}>{video.title}</Link>
          </h3>
        </div>
      </div>
    </li>
